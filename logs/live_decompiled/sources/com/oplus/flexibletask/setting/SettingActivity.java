...
import com.oplus.flexibletask.setting.fragment.SettingFragment;
...
public class SettingActivity extends BaseSettingActivity {
    ...
    private void initView() {
        ...
        if (cOUIToolbar != null) {
            cOUIToolbar.setTitle(j.f13660q0);
            cOUIToolbar.setNavigationIcon(g.f1467a);
            setSupportActionBar(cOUIToolbar);
            getSupportActionBar().s(true);
            cOUIToolbar.setNavigationOnClickListener(new View.OnClickListener() { // from class: com.oplus.flexibletask.setting.b
    ...
    public void onConfigurationChanged(Configuration configuration) {
        ...
        if (this.mIsFoldFrontScreen != FlexibleSettingHelper.getInstance().isFoldFrontScreen()) {
            ...
            try {
                getSupportFragmentManager().m().q(f.f13421A, this.mSettingFragment, TAG).h();
            } catch (Exception e3) {
