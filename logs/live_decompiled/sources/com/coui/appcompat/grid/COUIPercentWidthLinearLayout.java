...
public class COUIPercentWidthLinearLayout extends LinearLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, c.f1904G);
            this.mGridNumberResourceId = obtainStyledAttributes.getResourceId(c.f1905H, 0);
            this.mGridNumber = obtainStyledAttributes.getInteger(c.f1905H, getContext().getResources().getInteger(b.f1897a));
            this.mPaddingType = obtainStyledAttributes.getInteger(c.f1908K, 0);
            this.mPaddingSize = obtainStyledAttributes.getInteger(c.f1907J, 0);
            this.mPercentEnabled = obtainStyledAttributes.getBoolean(c.f1909L, true);
            this.mMode = obtainStyledAttributes.getInt(c.f1910M, 0);
            this.mIsParentChildHierarchy = obtainStyledAttributes.getBoolean(c.f1906I, false);
    ...
    public static class LayoutParams extends LinearLayout.LayoutParams {
        ...
        private void init(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.f1911N);
            this.mGridNumber = obtainStyledAttributes.getInt(c.f1912O, 0);
            this.mPercentMode = obtainStyledAttributes.getInt(c.f1913P, 0);
            obtainStyledAttributes.recycle();
        }
    ...
    public COUIPercentWidthLinearLayout(Context context, AttributeSet attributeSet, int i3) {
    ...
    public COUIPercentWidthLinearLayout(Context context, AttributeSet attributeSet, int i3, int i4) {
