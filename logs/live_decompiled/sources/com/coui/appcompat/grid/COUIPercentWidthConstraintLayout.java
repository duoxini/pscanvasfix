...
public class COUIPercentWidthConstraintLayout extends ConstraintLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, c.f1946m);
            this.mGridNumberResourceId = obtainStyledAttributes.getResourceId(c.f1947n, 0);
            this.mGridNumber = obtainStyledAttributes.getInteger(c.f1947n, getContext().getResources().getInteger(b.f1897a));
            this.mPaddingType = obtainStyledAttributes.getInteger(c.f1950q, 0);
            this.mPaddingSize = obtainStyledAttributes.getInteger(c.f1949p, 0);
            this.mPercentEnabled = obtainStyledAttributes.getBoolean(c.f1951r, true);
            this.mMode = obtainStyledAttributes.getInt(c.f1952s, 0);
            this.mIsParentChildHierarchy = obtainStyledAttributes.getBoolean(c.f1948o, false);
    ...
    public static class LayoutParams extends ConstraintLayout.b {
        ...
        private void init(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.f1953t);
            this.mGridNumber = obtainStyledAttributes.getInt(c.f1954u, 0);
            this.mPercentMode = obtainStyledAttributes.getInt(c.f1955v, 0);
            obtainStyledAttributes.recycle();
        }
    ...
    public COUIPercentWidthConstraintLayout(Context context, AttributeSet attributeSet, int i3) {
