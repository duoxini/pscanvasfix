...
public class COUIPercentWidthFrameLayout extends FrameLayout {
    ...
    private void initAttr(AttributeSet attributeSet) {
        if (getContext() != null) {
            TypedArray obtainStyledAttributes = getContext().obtainStyledAttributes(attributeSet, c.f1956w);
            this.mGridNumberResourceId = obtainStyledAttributes.getResourceId(c.f1957x, 0);
            this.mGridNumber = obtainStyledAttributes.getInteger(c.f1957x, getContext().getResources().getInteger(b.f1897a));
            this.mPaddingType = obtainStyledAttributes.getInteger(c.f1898A, 0);
            this.mPaddingSize = obtainStyledAttributes.getInteger(c.f1959z, 0);
            this.mPercentEnabled = obtainStyledAttributes.getBoolean(c.f1899B, true);
            this.mMode = obtainStyledAttributes.getInt(c.f1900C, 0);
            this.mIsParentChildHierarchy = obtainStyledAttributes.getBoolean(c.f1958y, false);
    ...
    public static class LayoutParams extends FrameLayout.LayoutParams {
        ...
        private void init(Context context, AttributeSet attributeSet) {
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, c.f1901D);
            this.mGridNumber = obtainStyledAttributes.getInt(c.f1902E, 0);
            this.mPercentMode = obtainStyledAttributes.getInt(c.f1903F, 0);
            obtainStyledAttributes.recycle();
        }
    ...
    public COUIPercentWidthFrameLayout(Context context, AttributeSet attributeSet, int i3) {
