...
class ViewOverlayApi14 implements ViewOverlayImpl {
    ...
    static class OverlayViewGroup extends ViewGroup {
        ...
        protected ViewParent invalidateChildInParentFast(int i3, int i4, Rect rect) {
            if (this.hostView == null || invalidateChildInParentFastMethod == null) {
                return null;
            }
            try {
                getOffset(new int[2]);
                invalidateChildInParentFastMethod.invoke(this.hostView, Integer.valueOf(i3), Integer.valueOf(i4), rect);
                return null;
        ...
        public void add(View view) {
            ...
            if (view.getParent() instanceof ViewGroup) {
                ...
                if (viewGroup != this.hostView && viewGroup.getParent() != null && y.N(viewGroup)) {
                    int[] iArr = new int[2];
                    int[] iArr2 = new int[2];
                    viewGroup.getLocationOnScreen(iArr);
                    this.hostView.getLocationOnScreen(iArr2);
                    y.T(view, iArr[0] - iArr2[0]);
                    y.U(view, iArr[1] - iArr2[1]);
                }
