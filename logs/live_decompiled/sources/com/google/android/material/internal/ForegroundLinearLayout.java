...
public class ForegroundLinearLayout extends LinearLayoutCompat {
    ...
    public ForegroundLinearLayout(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.foregroundBoundsChanged = false;
        TypedArray obtainStyledAttributes = ThemeEnforcement.obtainStyledAttributes(context, attributeSet, j.f794i2, i3, 0, new int[0]);
        this.foregroundGravity = obtainStyledAttributes.getInt(j.f802k2, this.foregroundGravity);
        Drawable drawable = obtainStyledAttributes.getDrawable(j.f798j2);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.mForegroundInPadding = obtainStyledAttributes.getBoolean(j.f806l2, true);
