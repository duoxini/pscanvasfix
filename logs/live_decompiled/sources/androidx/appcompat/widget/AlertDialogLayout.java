...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private static int d(View view) {
        int z3 = androidx.core.view.y.z(view);
        if (z3 > 0) {
            return z3;
        }
    ...
    private boolean e(int i3, int i4) {
        ...
        for (int i9 = 0; i9 < childCount; i9++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == e.f.f11189O) {
                    view = childAt;
                } else if (id == e.f.f11200k) {
                    view2 = childAt;
                } else {
                    if ((id != e.f.f11202m && id != e.f.f11204o) || view3 != null) {
                        return false;
                    }
                    view3 = childAt;
                }
    ...
    */
    protected void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L5a:
            ...
            r2 = r11
        L7e:
            int r3 = androidx.core.view.y.x(r17)
            int r2 = androidx.core.view.AbstractC0256e.b(r2, r3)
            r2 = r2 & 7
            r3 = 1
            if (r2 == r3) goto L98
            r3 = 5
