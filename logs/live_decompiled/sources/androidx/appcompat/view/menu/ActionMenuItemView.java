...
public class ActionMenuItemView extends C0251z implements MenuView.ItemView, View.OnClickListener, ActionMenuView.a {
    ...
    private class ActionMenuItemForwardingListener extends H {
    ...
    private void updateTextButtonVisibility() {
        ...
        if (TextUtils.isEmpty(tooltipText)) {
            Z.a(this, z5 ? null : this.mItemData.getTitle());
        } else {
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        H h3;
        if (this.mItemData.hasSubMenu() && (h3 = this.mForwardingListener) != null && h3.onTouch(this, motionEvent)) {
            return true;
        }
    ...
    public ActionMenuItemView(Context context, AttributeSet attributeSet, int i3) {
        ...
        this.mAllowTextWithIcon = shouldAllowTextWithIcon();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, j.f11440v, i3, 0);
        this.mMinWidth = obtainStyledAttributes.getDimensionPixelSize(j.f11444w, 0);
