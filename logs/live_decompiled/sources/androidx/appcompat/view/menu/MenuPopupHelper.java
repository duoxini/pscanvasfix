...
public class MenuPopupHelper implements MenuHelper {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder) {
        this(context, menuBuilder, null, false, AbstractC0339a.f11075D, 0);
    }
    ...
    private void showPopup(int i3, int i4, boolean z3, boolean z4) {
        MenuPopup popup = getPopup();
        popup.setShowTitle(z4);
        if (z3) {
            if ((AbstractC0256e.b(this.mDropDownGravity, y.x(this.mAnchorView)) & 7) == 5) {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view) {
        this(context, menuBuilder, view, false, AbstractC0339a.f11075D, 0);
    }

    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z3, int i3) {
    ...
    public MenuPopupHelper(Context context, MenuBuilder menuBuilder, View view, boolean z3, int i3, int i4) {
