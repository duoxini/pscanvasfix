...
final class StandardMenuPopup extends MenuPopup implements PopupWindow.OnDismissListener, AdapterView.OnItemClickListener, MenuPresenter, View.OnKeyListener {
    private static final int ITEM_LAYOUT = g.f11228m;
    ...
    public StandardMenuPopup(Context context, MenuBuilder menuBuilder, View view, int i3, int i4, boolean z3) {
        ...
        this.mPopupMaxWidth = Math.max(resources.getDisplayMetrics().widthPixels / 2, resources.getDimensionPixelSize(d.f11122b));
        this.mAnchorView = view;
        this.mPopup = new K(context, null, i3, i4);
    ...
    private boolean tryShow() {
        ...
        if (this.mShowTitle && this.mMenu.getHeaderTitle() != null) {
            FrameLayout frameLayout = (FrameLayout) LayoutInflater.from(this.mContext).inflate(g.f11227l, (ViewGroup) listView, false);
    ...
    public boolean onSubMenuSelected(SubMenuBuilder subMenuBuilder) {
        if (subMenuBuilder.hasVisibleItems()) {
            ...
            int b3 = this.mPopup.b();
            int d3 = this.mPopup.d();
            if ((Gravity.getAbsoluteGravity(this.mDropDownGravity, y.x(this.mAnchorView)) & 7) == 5) {
                b3 += this.mAnchorView.getWidth();
            }
            if (menuPopupHelper.tryShow(b3, d3)) {
                MenuPresenter.Callback callback = this.mPresenterCallback;
                if (callback == null) {
                    return true;
                }
